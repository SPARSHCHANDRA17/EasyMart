  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: "20px" }}>
        ...
        EasyMart domain strictly act uniquely as an educational development
      ...
      <p style={{ marginBottom: "15px" }}>
        The materials spanning the EasyMart interface may heavily include
      ...
      <p style={{ marginBottom: "15px" }}>
        EasyMart operates completely independent domains and takes strictly zero
